...
export default {
  ...
  // one entry for every project id `npm pack @museumwnf/glass-data`
  // carries in `manifest.projects` (checked 2026-09-19, glass-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/glass' },
