...
export default {
  ...
  home: {
    title: 'glass.identity.title',
    intro: 'glass.home.intro',
    cards: [
      {
        title: 'glass.nav.catalogue',
        description: 'glass.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'glass.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'glass.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'glass.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'glass.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'glass.partnerObjects.emptyPartner',
  //         emptyInstitution: 'glass.partnerObjects.emptyInstitution',
  //         institutionSummary: 'glass.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'glass.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'glass.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
