...
// `useGalleryData.js` used to be byte-identical local copies of what glass
...
// legacy project key, no UUID — glass shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (glass-data 1.0.11+), an outside
