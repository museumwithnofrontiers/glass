...
The **Museum With No Frontiers — Glass** gallery, built from the published
dataset `@museumwnf/glass-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/glass-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/glass/> through the reusable workflows in
